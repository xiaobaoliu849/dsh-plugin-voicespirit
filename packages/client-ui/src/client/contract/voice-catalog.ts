...
export const DOUBAO_VOICES: readonly VoiceCatalogEntry[] = [
  ...
  },
  {
    ...
    displayNameZh: '肉丸丸 (可爱萌趣)',
    gender: 'male',
    language: 'zh',
    tags: ['可爱', '萌趣', '亲切'],
    description: 'Cute, playful male persona.',
    descriptionZh: '亲切可爱的萌趣男声，陪伴感强。',
  },
  {
    id: 'zh_female_rouse_jupiter_bigtts',
    displayName: 'Rouse (Jupiter)',
    displayNameZh: '柔丝 (温润治愈)',
    gender: 'female',
    language: 'zh',
    tags: ['温润', '治愈', '舒缓'],
    description: 'Gentle, soothing tone.',
    descriptionZh: '柔和温润的声线，适合夜间与陪伴。',
  },
  {
    id: 'zh_male_shenyeboke_moon_bigtts',
    displayName: 'Midnight (Moon)',
    displayNameZh: '深夜播客 (磁性深沉)',
    gender: 'male',
    language: 'zh',
    tags: ['磁性', '深沉', '播客'],
    description: 'Deep magnetic male voice for narration.',
    descriptionZh: '磁性深沉的男中音，适合叙事与电台。',
  },
  {
    id: 'zh_female_shuangkuaisisi_moon_bigtts',
    displayName: 'Sisi (Moon)',
    displayNameZh: '爽快思思 (干练清脆)',
    gender: 'female',
    language: 'zh',
    tags: ['干练', '清脆', '职场'],
    description: 'Crisp, articulate female assistant voice.',
    descriptionZh: '清脆干练的女声，反应敏捷。',
  },
  {
    id: 'zh_male_chunhouba_moon_bigtts',
    displayName: 'Uncle (Moon)',
    displayNameZh: '醇厚大叔 (沉稳厚重)',
    gender: 'male',
    language: 'zh',
    tags: ['沉稳', '厚重', '温暖'],
    description: 'Warm and calm mature male tone.',
    descriptionZh: '沉稳厚重的大叔音，温暖安心。',
  },
  {
    id: 'zh_female_tianmeixiaoling_moon_bigtts',
    displayName: 'Xiaoling (Moon)',
    displayNameZh: '甜美小玲 (温婉自然)',
    gender: 'female',
    language: 'zh',
    tags: ['甜美', '温婉', '亲和'],
    description: 'Sweet, pleasant female voice.',
    descriptionZh: '温婉甜美的女声，如沐春风。',
  },
]
